...
func (*Command_ArgValidateCode) Descriptor() ([]byte, []int) {
	return fileDescriptor_tele_d35674bd493f8fde, []int{2, 5}
}
...
func (*Command_ArgCook) Descriptor() ([]byte, []int) {
	return fileDescriptor_tele_d35674bd493f8fde, []int{2, 6}
}
...
func (m *Command_ArgCook) GetCredit() uint32 {
	if m != nil {
		return m.Credit
	}
	return 0
...
type Response struct {
	...
	CookReplay           CookReplay `protobuf:"varint,7,opt,name=cook_replay,json=cookReplay,proto3,enum=tele.CookReplay" json:"cook_replay,omitempty"`
	INTERNALTopic        string     `protobuf:"bytes,2048,opt,name=INTERNAL_topic,json=INTERNALTopic,proto3" json:"INTERNAL_topic,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
